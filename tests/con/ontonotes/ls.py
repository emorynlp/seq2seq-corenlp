...
from elit.datasets.srl.ontonotes5.english import ONTONOTES5_CON_ENGLISH_TEST, ONTONOTES5_CON_ENGLISH_DEV, \
...
scores = []
for i in range(3):
    save_dir = f'data/model/con/ontonotes/ls/{i}'
    ...
    con.fit(
        ...
        save_dir,
        BracketedVerbalizer(flatten_pos=True, anonymize_token=True),
        epochs=30,
        eval_after=25,
