...
from elit.components.seq2seq.con.verbalizer import IsAPhraseVerbalizer
...
scores = []
for i in range(3):
    save_dir = f'data/model/con/ontonotes/pt/{i}'
    ...
    con.fit(
        ...
        save_dir,
        verbalizer=IsAPhraseVerbalizer(
            label_to_phrase={
                ...
                "SINV": "an inverted clause",
                "SQ": "an interrogative clause",
                "NML": "a nominal",
                'META': 'a meta tag',
                'TOP': 'a sentence',
                'EMBED': 'an embedding'
    ...
    con.load(save_dir, max_prompt_len=None)
