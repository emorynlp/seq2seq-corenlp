...
from elit.datasets.srl.ontonotes5._utils import make_gold_conll, make_ontonotes_language_jsonlines, \
    ...
    batch_make_srl_json_if_necessary, batch_make_coref_json_if_necessary, make_raw_text_if_necessary
...
ONTONOTES5_COREF_ENGLISH_TRAIN = _ONTONOTES5_CONLL12_ENGLISH_HOME + 'train.english.v4.coref.jsonlines'
ONTONOTES5_COREF_ENGLISH_DEV = _ONTONOTES5_CONLL12_ENGLISH_HOME + 'development.english.v4.coref.jsonlines'
ONTONOTES5_COREF_ENGLISH_TEST = _ONTONOTES5_CONLL12_ENGLISH_HOME + 'test.english.v4.coref.jsonlines'
...
ONTONOTES5_ENGLISH_TEXT = _ONTONOTES5_ENGLISH_HOME + 'text.jsonlines'
...
batch_make_coref_json_if_necessary(
    [ONTONOTES5_ENGLISH_TRAIN, ONTONOTES5_ENGLISH_DEV, ONTONOTES5_ENGLISH_TEST])

make_raw_text_if_necessary(_ONTONOTES5_ENGLISH_HOME)
