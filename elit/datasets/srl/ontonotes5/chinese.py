...
ONTONOTES5_COREF_CHINESE_TRAIN = _ONTONOTES5_CONLL12_CHINESE_HOME + 'train.chinese.v4.coref.jsonlines'
ONTONOTES5_COREF_CHINESE_DEV = _ONTONOTES5_CONLL12_CHINESE_HOME + 'development.chinese.v4.coref.jsonlines'
ONTONOTES5_COREF_CHINESE_TEST = _ONTONOTES5_CONLL12_CHINESE_HOME + 'test.chinese.v4.coref.jsonlines'
